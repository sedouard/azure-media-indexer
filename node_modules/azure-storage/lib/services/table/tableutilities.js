  ...
  entityGenerator: (function()
  {
    var Entity = function (value, type) {
      ...
      Int32 : function(value) {
        return Entity(value, 'Edm.Int32');
      },

      Int64 : function(value) {
        return Entity(value, 'Edm.Int64');
      },

      Binary : function(value) {
        return Entity(value, 'Edm.Binary');
      },

      Boolean : function(value) {
        return Entity(value, 'Edm.Boolean');
      },

      String : function(value) {
        return Entity(value, 'Edm.String');
      },

      Guid : function(value) {
        return Entity(value, 'Edm.Guid');
      },

      Double : function(value) {
        return Entity(value, 'Edm.Double');
      },

      DateTime : function(value) {
        return Entity(value, 'Edm.DateTime');
      }
    }
  })()
};
